        ...
        <script>
            ...
            $(function(){                 
               $(document).ready(function() {
                    $('#bilDictDataTable').dataTable({
                        "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]]
                    });
                });

                $(document).ready(function() {
                    $('#corpDataTable').dataTable({
                        "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]]
                    });
                });
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div id="tabs">
                        <ul>
                        <li><a href="#tabs-1"> Bilingual Dictionary </a></li>
                        <li><a href="#tabs-2"> Corpora </a></li>                       
                        </ul>
                         ...
                         <div id="tabs-1">
                               ...
                               $result = mysqli_query($con,"SELECT * FROM tblbilingualdictionary");

                               echo " <div id = 'DTbilDict'>                        
                                        <table id='bilDictDataTable' class='display'>
                                            <thead>
                                                <tr>
                                                <th> Tagalog</th> 
                                                <th> Chabacano</th> 
                                ...
                                echo "<tbody>    
                                    ...
                                    while($row = mysqli_fetch_array($result))
                                      ...
                                      echo "<tr>";
                                      echo "<td>" . $row['wrdTagalog'] . "</td>";
                                      echo "<td>" . $row['wrdChabacano'] . "</td>";
                                      echo "</tr>";
                                      }
                        ...
                        <div id="tabs-2">
                               ...
                               $result = mysqli_query($con,"SELECT * FROM tblcorpora");

                               echo " <div id = 'DTcorp'>                        
                                        <table id='corpDataTable' class='display'>
                                            <thead>
                                                <tr>
                                                <th> Source Text</th> 
                                                <th> Target Text</th> 
